...
start_day = 366+365
end_day = 731+365+365
data = load_data('New_data/Matrix_dayAhead_Real.csv')
...
for window in windows:
    ...
    for h in range(24):
        ...
        X8 = data_day['L'].values.tolist()
        X9 = data_day['W'].values.tolist()
        X10 = data_day['S'].values.tolist()
...
new_df.to_csv('New_data/Forecast_dayAhead_real_2017_2018.csv', index=False,  header=False)
