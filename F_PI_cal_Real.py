...
Y_TSO_1 = pd.read_csv('New_data/Y_Intraday1_Real.csv', delimiter=',',header=None, index_col=False)
#print((Y_TSO_1))
...
print("Intraday REAL 1:", sum_of_elements)


Y_TSO_2 = pd.read_csv('New_data/Y_Intraday2_Real.csv', delimiter=',',header=None, index_col=False)
#print((Y_TSO_1))
...
print("Intraday REAL 2:", sum_of_elements2) ##### PODZIELONE PRZEZ 2!!!!


Y_TSO_3 = pd.read_csv('New_data/Y_Intraday3_Real.csv', delimiter=',',header=None, index_col=False)
...
print("Intraday REAL 3:", sum_of_elements3)