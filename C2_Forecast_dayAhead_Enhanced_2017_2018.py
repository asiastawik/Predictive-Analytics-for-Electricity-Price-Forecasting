...
start_day = 366+365
end_day = 731+365+365
data = load_data('New_data/Matrix_dayAhead_Enhanced.csv')
...
for window in windows:
    ...
    for h in range(24):
        ...
        for d in range(start_day,end_day):  # Adjust the range as needed 731
            ...
            X = np.column_stack([X0_subset, X1_subset, X2_subset, X3_subset, X4_subset, X5_subset, X6_subset, X7_subset, X8_subset,X9_subset, X10_subset])
...
new_df.to_csv('New_data/Forecast_dayAhead_enhanced_2017_2018.csv', index=False,  header=False)
