...
DA_Forecast = load_data('New_data/Forecast_dayAhead_TSO_2017_2018.csv') *4 # te zmienic na enhanced
...
data_final = data[['X0', 'DA_Forecast', 'ID*', 'L', 'W', 'S', 'Intraday']]
data_final.to_csv('New_data/Matrix_Intraday3_TSO.csv', index=False)
